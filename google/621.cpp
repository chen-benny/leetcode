...
// greedy math + char-index array, T: O(n), S: O(1) stack-allocated
...
// math formula derivation: maxFreq creates maxFreq-1 gaps of size n+1, total=(maxFreq-1)*(n+1)+maxCount or tasks.size()
// maxCount necessity: e.g. AAABB with n=2, maxFreq=3, 
// std::max_element on flat array
// cache freq[26] is 104 bytes: fits in two cache liens in L1
// n = 0
